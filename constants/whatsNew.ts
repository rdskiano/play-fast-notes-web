...
export const WHATS_NEW: WhatsNewEntry[] = [
  ...
  },
  {
    ...
    body:
      'Fixed on the iPad and iPhone app: playing back a recording could leave the metronome silent until you restarted the app — it now reclaims the speaker every time you press play. On phones, practice screens got breathing room: the tool buttons no longer overlap the tracker pill at the top (Tempo Ladder, Click-Up, and Rhythm Variations), the collapsed recorder tucks into the corner instead of sitting on your music, its playback speeds fit the card, and adding prompt cues opens a small box pinned to the top of the screen where the keyboard can never hide it. The book-mode Click-Up metronome also grew up: the performance tempo uses the same stepper-and-slider control as everywhere else, with its own play button to hear the tempo before you commit.',
  },
  {
