...
- Auth is **magic-link email only**. No password flow. Configured in `lib/supabase/auth.ts`.
...
- Magic-link redirect URLs configured in Supabase Auth → URL Configuration.
