...
- **First-practice measurement screen redesigned 2026-08-18** (Ralph's mock): big score card + real metronome (slider, live tempo word) on every step, "Lock in ♩ = N" commits. Built + simulator-verified, NOT yet deployed — awaiting Ralph's web check.
