  ...
  return (
    <ThemedView style={{ flex: 1 }}>
      ...
      <TutorialStep
        ...
        body={
          "Drag the corner handles to resize the crop, or drag the whole rectangle to reposition it, until it frames just the music you want to practice. Trim white margins, page edges, anything that distracts.\n\n" +
